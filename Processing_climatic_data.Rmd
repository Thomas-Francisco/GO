...
colnames(past_climatic_data_layer)[3:14] <- paste0(colnames(past_climatic_data_layer)[3:14], "_layer_of_points")
...
correlation_function <-function(data,threshold,discard_variables){
...
threshold <- 0.7
correlation_past <-correlation_function(data_present,threshold,discard_variables)
discard_variables <- Population,Country
...
data_past_climatic_data <- comp_past_climatic_data_1901_1950[,c()]
...
data <- comp_past_climatic_data_1901_1950
revelant_variables_graph <- comp_past_climatic_data_1901_1950[,-c(1,2)]
regions <-comp_past_climatic_data_1901_1950$Country
colnames(comp_past_climatic_data_1901_1950)=c("Population","Country","bio1","bio2","bio3","bio4","bio5","bio10","bio11","bio12","bio13","bio14","bio15","AHM")
bioclim_vars <- c("bio1", "bio2", "bio3", "bio4","bio5","bio10","bio11","bio12","bio13","bio14","bio15","AHM")
